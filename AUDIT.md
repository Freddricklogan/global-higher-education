# Conversion audit — global-higher-education
...
- Inline style attributes converted to classes: 58 occurrences, 15 distinct declarations.
...
- Buttons given an explicit type: 9; tables given a <tbody>: 3; <th> given a scope: 10; raw ampersands encoded: 6; top navigation given an accessible name.
- Sections with ids: 17 (meaning, rationales, explorer, mobility, services, systems, comparative, bologna, rankings, tne, virtualexchange, lifecycle, funding, decolonizing, equity, selfcheck, glossary).
